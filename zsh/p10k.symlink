# Generated by Powerlevel10k configuration wizard on 2023-10-02 at 13:10 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 53041.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, slanted separators, sharp heads, round tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=124
  ...
  function my_git_formatter() {
    ...
    local    stashed='%66'   # aqua foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      if [[ 
        $VCS_STATUS_HAS_UNSTAGED -gt 0 || 
        $VCS_STATUS_HAS_STAGED -gt 0 ||
        $VCS_STATUS_COMMITS_AHEAD -gt 0 ||
        $VCS_STATUS_COMMITS_BEHIND -gt 0
      ]] then
        res+="${modified}${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}${branch//\%/%%}"
      elif [[ 
        $VCS_STATUS_HAS_CONFLICTED -gt 0 ||
        ($VCS_STATUS_COMMITS_BEHIND -gt 0 && $VCS_STATUS_COMMITS_AHEAD -gt 0) 
      ]] then
    ...
    (( VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" ${modified}⇠${VCS_STATUS_PUSH_COMMITS_BEHIND}"
    (( VCS_STATUS_PUSH_COMMITS_AHEAD && !VCS_STATUS_PUSH_COMMITS_BEHIND )) && res+=" "
    # ⇢42 if ahead of the push remote; no leading space if also behind: ⇠42⇢42.
    (( VCS_STATUS_PUSH_COMMITS_AHEAD  )) && res+="${modified}⇢${VCS_STATUS_PUSH_COMMITS_AHEAD}"
    # *42 if have stashes.
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=234
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=234

  ###################[ command_execution_time: duration of the last command ]###################
  # Execution time color.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=0
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=172
  # Show duration of the last command if takes at least this many seconds.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=172
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=66
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=172
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_BACKGROUND=72
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_BACKGROUND=72
  # Text and color for visual vi mode.
  typeset -g POWERLEVEL9K_VI_VISUAL_MODE_STRING=VISUAL
  typeset -g POWERLEVEL9K_VI_MODE_VISUAL_BACKGROUND=214
  # Text and color for overtype (a.k.a. overwrite and replace) vi mode.
  typeset -g POWERLEVEL9K_VI_OVERWRITE_MODE_STRING=OVERTYPE
  typeset -g POWERLEVEL9K_VI_MODE_OVERWRITE_BACKGROUND=172
  ...
  ##########[ nodenv: node.js version from nodenv (https://github.com/nodenv/nodenv) ]##########
  # Nodenv color.
  typeset -g POWERLEVEL9K_NODENV_FOREGROUND=72
  ...
  ############[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]############
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=72
  ...
  typeset -g POWERLEVEL9K_NODE_VERSION_BACKGROUND=72
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=72
  ...
  typeset -g POWERLEVEL9K_AWS_EB_ENV_FOREGROUND=72
  ...
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=72
